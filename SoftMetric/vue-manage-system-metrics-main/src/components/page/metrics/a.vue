<template>
    <el-container style='display: block'>
        ...
        <el-card class="box-card" style='width: 100%;display: flex'>
            ...
            <el-button style='margin-top: 10px;margin-left: 50%' class="submit" type="primary" @click="uploadFile">上传文件</el-button>
        </el-card>
                ...
                tooltip: {
                    ...
                    formatter: function (params) {
                        ...
                        params.value.forEach((val, index) => {
                            valueStr += `${option.radar.indicator[index].name}: ${val}<br/>`;
                        });
                        return `${params.seriesName}<br/>${valueStr}`;
                    },
                    extraCssText: 'box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); border-width: 2px;',
                },
                legend: {
                    data: legendData,
